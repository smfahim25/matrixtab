...
var speed = 1.5; //base speed (added to each node random speed)
var nodeAmount = 150; //node amount, the more the slower
...
var drawLineThreshold = 170; //the threshold for drawing the lines, the more the slower
